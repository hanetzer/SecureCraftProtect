...
public class SCPModelReal682 extends ModelBase
{
	...
	{
		SCPEntityReal682 var8 = (SCPEntityReal682)entity;
		...
		if(var8.isGrowling){
			mouth.rotateAngleX = (float)(Math.sin((double)((float)Math.PI * 5.0F)) + 1.0D) * 0.25F;
			jaw.rotateAngleX = (float)(Math.sin((double)((float)Math.PI * 5.0F)) + 1.0D) * 0.05F;
		}
		else{
			mouth.rotateAngleX = f4 / (180F / (float)Math.PI);
			jaw.rotateAngleX = f4 / (180F / (float)Math.PI);
