...
public class SCPSmokeFX5 extends EntityFX
{
    float smokeParticleScale;
    public int getMetadata;

    public SCPSmokeFX5(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        this(par1World, par2, par4, par6, par8, par10, par12, 1.0F);
    }

    public SCPSmokeFX5(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, float par14)
    {
    ...
    public void onUpdate()
    {
        ...
        motionX -= 0.0040000000000000001D;
