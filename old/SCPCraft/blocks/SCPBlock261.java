...
public class SCPBlock261 extends BlockContainer
{
	public SCPBlock261(int par1)
	{
	...
	public AxisAlignedBB getSelectedBoundingBoxFromPool_do(World world, int i, int j, int k)
	{
		...
		if(l == 0 || l == 2) setBlockBounds(0.1F, 0.0F, 0.201F, 0.9F, 1.52F, 0.82F);
		if(l == 1 || l == 3) setBlockBounds(0.201F, 0.0F, 0.1F, 0.82F, 1.52F, 0.9F);
	...
	public void addCollidingBlockToList(World par1World, int par2, int par3, int par4, AxisAlignedBB par5AxisAlignedBB, List par6ArrayList, Entity par7Entity)
	{
		...
		if(i == 0 || i == 2) setBlockBounds(0.1F, 0.0F, 0.201F, 0.9F, 1.52F, 0.82F);
		if(i == 1 || i == 3) setBlockBounds(0.201F, 0.0F, 0.1F, 0.82F, 1.52F, 0.9F);
	...
	{
		SCPTileEntity261 var7 = (SCPTileEntity261)par1World.getBlockTileEntity(par2, par3, par4);
		if (var7 != null)
		{
	...
	public boolean onBlockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5, int var6, float var7, float var8, float var9)
	{
		...
		var5.openGui(mod_SCP.instance, 1, var1, var2, var3, var4);
		return true;
	}

	public TileEntity createNewTileEntity(World var1)
	{
		return new SCPTileEntity261();
	}
}
