...
public class SCPBlockCustomWaterFlowing extends SCPBlockFluid
{
    /**
    ...
    protected SCPBlockCustomWaterFlowing(int par1, Material par2Material)
    {
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
		...
		if (par5Random.nextInt(10) == 0) {
			...
			if (i <= 0 || i >= 8) {
				par1World.spawnParticle("mobSpell", (float) par2 + par5Random.nextFloat(), (float) par3 + par5Random.nextFloat(), (float) par4 + par5Random.nextFloat(), red, green, blue);
			}
		}
	}
