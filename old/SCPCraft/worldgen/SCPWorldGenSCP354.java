...
public class SCPWorldGenSCP354 extends WorldGenerator
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        par3 -= 8;
        par4 -= 4;
        boolean aflag[] = new boolean[4096];
        ...
        if (Block.blocksList[blockIndex].blockMaterial == SCPMaterial.SCP354)
        {
            for (int j1 = 0; j1 < 16; j1++)
            {
                for (int k2 = 0; k2 < 16; k2++)
                {
                    for (int l3 = 0; l3 < 8; l3++)
                    {
                        ...
                        {
                            par1World.setBlock(par3 + j1, par4 + l3, par5 + k2, mod_SCP.BloodBlock.blockID);
                        }
                    }
                }
            }
