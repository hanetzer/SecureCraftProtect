...
public class SCPGuiIngame extends GuiIngame
{
    ...
    public SCPGuiIngame(Minecraft par1Minecraft)
    {
    	super(par1Minecraft);
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (!this.mc.playerController.enableEverythingIsScrewedUpMode())
        {
            ...
            this.drawTexturedModalRect(width / 2 - 91 - 1 + inventoryplayer.currentItem * 20, height - 22 - 1, 0, 22, 24, 22);
            ...
            //TODO
            this.renderSCP015BossHealth();            
            this.renderSCP682Health();
            ...
            if (this.mc.playerController.shouldDrawHUD())
            {
                ...
                for (j4 = 0; j4 < 10; ++j4)
                {
                    ...
                    //TODO
                    if (this.mc.thePlayer.isPotionActive(SCPPotion.crystal))
                    {
                        GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/SCPCraft/textures/gui/SCPIcons.png"));
                        j3 += 18;
                    }
                ...
                for (j4 = 0; j4 < 10; ++j4)
                {
                    ...
                    k4 = i4 - j4 * 8 - 9;
                    //TODO
                    this.drawTexturedModalRect(k4, j3, 16 + b2 * 9, hungerY, 9, 9);
                    ...
                    if (flag2)
                    {
                        ...
                        {
                            //TODO
                            this.drawTexturedModalRect(k4, j3, l3 + 54, hungerY, 9, 9);
                        }

                        if (j4 * 2 + 1 == k1)
                        {
                            //TODO
                            this.drawTexturedModalRect(k4, j3, l3 + 63, hungerY, 9, 9);
                        }
                    }
                    ...
                    {
                        //TODO
                        this.drawTexturedModalRect(k4, j3, l3 + 36, hungerY, 9, 9);
                    }

                    if (j4 * 2 + 1 == l1)
                    {
                        //TODO
                        this.drawTexturedModalRect(k4, j3, l3 + 45, hungerY, 9, 9);
                    }
                }
            ...
            //TODO
            this.mc.mcProfiler.startSection("blinkBar");
            if(mod_SCP.isActive){
                k2 = height - 20;
                int var25 = this.mc.thePlayer.getBlink();
                i4 = width / 2 + 91;
                int var26 = MathHelper.ceiling_double_int((double)(var25 + 2) * 10.0D / 300.0D);
                GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/SCPCraft/textures/gui/SCPIcons.png"));
                this.drawTexturedModalRect(i4 - 281, k2 - 1, 0, 18, 83, 11);
                this.drawTexturedModalRect(i4 - 301, k2 - 1, 83, 18, 17, 11);

                for (int var28 = 0; var28 < 10; ++var28)
                {
                    if (var28 < var26)
                    {
                        this.drawTexturedModalRect(i4 + var28 * 8 - 280, k2, 100, 18, 9, 9);
                    }
                }
            }
        ...
        //TODO
        if(this.mc.thePlayer.isPotionActive(SCPPotion.bloodStone))
        {
            this.mc.mcProfiler.startSection("taint");
            GL11.glDisable(GL11.GL_DEPTH_TEST);
            GL11.glDisable(GL11.GL_ALPHA_TEST);
            int var32 = 25;
            int color = 5570560;
            if(mc.thePlayer.getActivePotionEffect(SCPPotion.bloodStone).getAmplifier() == 1){
            	color = 8521728;
            	var32 = 50;
            }
            if(mc.thePlayer.getActivePotionEffect(SCPPotion.bloodStone).getAmplifier() == 2){
            	color = 4981504;
            	var32 = 100;
            }
            f2 = (float)var32 / 100.0F;

            if (f2 > 1.0F)
            {
                f2 = 1.0F - (float)(var32 - 100) / 10.0F;
            }

            i1 = (int)(220.0F * f2) << 24 | color;
            drawRect(0, 0, width, height, i1);
            GL11.glEnable(GL11.GL_ALPHA_TEST);
            GL11.glEnable(GL11.GL_DEPTH_TEST);
            this.mc.mcProfiler.endSection();
        }
        if(this.mc.thePlayer.isPotionActive(SCPPotion.eaten))
        {
            this.mc.mcProfiler.startSection("eat");
            GL11.glDisable(GL11.GL_DEPTH_TEST);
            GL11.glDisable(GL11.GL_ALPHA_TEST);
            int var32 = 3835/(mc.thePlayer.getActivePotionEffect(SCPPotion.eaten).getDuration() + 1);
            f2 = (float)var32 / 100.0F;
            i1 = var32 << 24 | 0;
            drawRect(0, 0, width, height, i1);
            GL11.glEnable(GL11.GL_ALPHA_TEST);
        ...
        if (this.mc.playerController.func_78763_f() && this.mc.thePlayer.experienceLevel > 0)
        {
            ...
            j5 = (width - fontrenderer.getStringWidth(s)) / 2;
            k5 = height - 31 - 4;
        ...
        if (this.mc.gameSettings.heldItemTooltips)
        {
            ...
            if (this.field_92017_k > 0 && this.field_92016_l != null)
            {
                ...
                i1 = (width - fontrenderer.getStringWidth(s1)) / 2;
                j1 = height - 59;
        ...
        if (this.mc.isDemo())
        {
            ...
            fontrenderer.drawStringWithShadow(s1, width - i1 - 10, 5, 16777215);
            this.mc.mcProfiler.endSection();
        }
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            this.drawString(fontrenderer, s2, width - fontrenderer.getStringWidth(s2) - 2, 2, 14737632);
            s2 = "Allocated memory: " + i6 * 100L / l5 + "% (" + i6 / 1024L / 1024L + "MB)";
            this.drawString(fontrenderer, s2, width - fontrenderer.getStringWidth(s2) - 2, 12, 14737632);
        ...
        if (this.recordPlayingUpFor > 0)
        {
            ...
            if (i1 > 0)
            {
                ...
                //TODO
                if(this.recordPlaying.contains("106"))this.recordPlaying = "Now playing: GlennLeroi - 106";
                if(this.recordPlaying.contains("173"))this.recordPlaying = "Now playing: GlennLeroi - 173";
                if(this.recordPlaying.contains("173E"))this.recordPlaying = "Now playing: GlennLeroi - 173 - Extended";
                if(this.recordPlaying.contains("914"))this.recordPlaying = "Now playing: GlennLeroi - 914";
                if(this.recordPlaying.contains("079"))this.recordPlaying = "Now playing: GlennLeroi - 079";
                if(this.recordPlaying.contains("789J"))this.recordPlaying = "Now playing: GlennLeroi - 789-J";
                if(this.recordPlaying.contains("087"))this.recordPlaying = "Now playing: GlennLeroi - 087";
                if(this.recordPlaying.contains("096"))this.recordPlaying = "Now playing: GlennLeroi - 096";
                if(this.recordPlaying.contains("420J"))this.recordPlaying = "Now playing: GlennLeroi - 420-J";
        ...
        {
            this.func_96136_a(scoreobjective, height, width, fontrenderer);
        }
    ...
    {
        if (SCPRender015Boss.entityPipe != null)
        {
            SCPEntity015Boss var1 = SCPRender015Boss.entityPipe;
            SCPRender015Boss.entityPipe = null;
            ...
            int var7 = (int)((float)var1.getSCP015BossHealth() / (float)var1.getMaxHealth() * (float)(var5 + 1));
            byte var8 = 12;
            this.drawTexturedModalRect(var6, var8, 0, 30, var5, 5);
            this.drawTexturedModalRect(var6, var8, 0, 30, var5, 5);

            if (var7 > 0)
            {
                this.drawTexturedModalRect(var6, var8, 0, 35, var7, 5);
            }

            String var9 = "Nightmare Pipe Boss health";
            var2.drawStringWithShadow(var9, var4 / 2 - var2.getStringWidth(var9) / 2, var8 - 10, 14496512);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    {
        if (SCPRender682.entity682 != null)
        {
            SCPEntityReal682 var1 = SCPRender682.entity682;
            SCPRender682.entity682 = null;
            FontRenderer var2 = this.mc.fontRenderer;
            ScaledResolution var3 = new ScaledResolution(this.mc.gameSettings, this.mc.displayWidth, this.mc.displayHeight);
            GL11.glColor4f(1F, 1.0F, 1F, 1.0F);
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/SCPCraft/textures/gui/SCPIcons.png"));
            int var4 = var3.getScaledWidth();
            short var5 = 182;
            int var6 = var4 / 2 - var5 / 2;
            int var7 = (int)((float)var1.getSCP682Health() / (float)var1.getMaxHealth() * (float)(var5 + 1));
            byte var8 = 12;
            this.drawTexturedModalRect(var6, var8, 0, 41, var5, 5);
            this.drawTexturedModalRect(var6, var8, 0, 41, var5, 5);

            if (var7 > 0)
            {
                this.drawTexturedModalRect(var6, var8, 0, 46, var7, 5);
            }

            String var9 = "SCP-682 health";
            var2.drawStringWithShadow(var9, var4 / 2 - var2.getStringWidth(var9) / 2, var8 - 10, 417792);
            GL11.glColor4f(1F, 1.0F, 1F, 1.0F);
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/gui/icons.png"));
        }  
    }
    ...
    /**
     * Renders the vignette. Args: vignetteBrightness, width, ysize
     */
    ...
    /**
     * Renders the portal overlay. Args: portalStrength, width, ysize
     */
