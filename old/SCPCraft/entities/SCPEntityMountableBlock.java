...
public class SCPEntityMountableBlock extends Entity
{
	...
	public SCPEntityMountableBlock (World world)
	{
		super(world);
        noClip = true;
	...
	public SCPEntityMountableBlock (World world, double d, double d1, double d2)
	{
        super(world);
        noClip = true;
        preventEntitySpawning = true;
	...
	public SCPEntityMountableBlock (World world, EntityPlayer entityplayer, int i, int j, int k, float mountingX, float mountingY, float mountingZ)
	{
		super(world);
        noClip = true;
        preventEntitySpawning = true;
    ...
    public void onEntityUpdate()
    {
        ...
        else if(worldObj.getBlockId(getOrgBlockPosX(), getOrgBlockPosY(), getOrgBlockPosZ()) != orgBlockID)
		{
