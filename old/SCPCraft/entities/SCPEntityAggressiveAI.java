...
public class SCPEntityAggressiveAI extends EntityAIBase
{
    World worldObj;
    ...
    public SCPEntityAggressiveAI(EntityLiving par1EntityLiving, Class par2Class, float par3, boolean par4)
    {
        this(par1EntityLiving, par3, par4);
        this.classTarget = par2Class;
    }

    public SCPEntityAggressiveAI(EntityLiving par1EntityLiving, float par2, boolean par3)
    {
        this.attackTick = 0;
