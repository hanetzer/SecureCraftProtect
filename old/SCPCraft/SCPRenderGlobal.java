...
public class SCPRenderGlobal extends RenderGlobal
{
    ...
    public SCPRenderGlobal(Minecraft par1Minecraft, RenderEngine par2RenderEngine)
    {
    ...
    public void spawnParticle(String par1Str, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        ...
        catch (Throwable throwable)
        {
            ...
            crashreportcategory.addCrashSectionCallable("Position", new SCPCallableParticlePositionInfo(this, par2, par4, par6));
    ...
    public EntityFX doSpawnParticle(String par1Str, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        if (this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null)
        {
            int i = this.mc.gameSettings.particleSetting;
         	//TODO
            boolean isSCP = false;
            if (i == 1 && this.theWorld.rand.nextInt(3) == 0 && !isSCP)
            {
                i = 2;
            }
            ...
            else
            {
                double d9 = 16.0D;
                //TODO
                if (par1Str.equals("SCPsmoke"))
                {
                    entityfx = new SCPSmokeFX(this.theWorld, par2, par4, par6, par8, par10, par12, 4.5F);
                    isSCP = true;
                }
                else if (par1Str.equals("SCPsmoke2"))
                {
                    entityfx = new SCPSmokeFX2(this.theWorld, par2, par4, par6, par8, par10, par12, 4.5F);
                    isSCP = true;
                }
                else if (par1Str.equals("SCPsmoke3"))
                {
                    entityfx = new SCPSmokeFX3(this.theWorld, par2, par4, par6, par8, par10, par12, 4.5F);
                    isSCP = true;
                }
                else if (par1Str.equals("SCPsmoke4"))
                {
                    entityfx = new SCPSmokeFX4(this.theWorld, par2, par4, par6, par8, par10, par12, 4.5F);
                    isSCP = true;
                }
                else if (par1Str.equals("SCPsmoke5"))
                {
                    entityfx = new SCPSmokeFX5(this.theWorld, par2, par4, par6, par8, par10, par12, 4.5F);
                    isSCP = true;
                }
                else if (par1Str.equals("SCPsmoke6"))
                {
                    entityfx = new SCPSmokeFX6(this.theWorld, par2, par4, par6, par8, par10, par12, 4.5F);
                    isSCP = true;
                }        
                else if (par1Str.equals("SCP080"))
                {
                    entityfx = new SCP080FX(this.theWorld, par2, par4, par6, par8, par10, par12, 2.0F);
                    isSCP = true;
                }        
                else if (par1Str.equals("electricity"))
                {
                	entityfx = new SCPEntityElectricityFX(this.theWorld, par2, par4, par6, par8, par10, par12);
                    isSCP = true;
                }
                else if (par1Str.equals("orange"))
                {
                    entityfx = new EntityBreakingFX(this.theWorld, par2, par4, par6, Item.blazePowder, this.renderEngine);
                    isSCP = true;
                }
                else if (par1Str.equals("cry"))
                {
                    entityfx = new SCPCryFX(this.theWorld, par2, par4, par6, par8, par10, par12);
                    isSCP = true;
                }
