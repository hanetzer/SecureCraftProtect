...
public class SCPItem682 extends SCPItemDocument
{
	...
	{
		list.add("\u00a74SCP-682");
		list.add("\u00a77Hard-to-Destroy Reptile");
	}
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			par2EntityPlayer.addChatMessage("SCP-682 Spawned." + " | [Type: \u00a74Keter\u00a7f]");
	...
	{
		SCPEntity682 var8 = new SCPEntity682(par0World);
