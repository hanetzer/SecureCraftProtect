...
public class SCP217Testificate extends SCPItem217
{
	private int color;

	public SCP217Testificate(int par1, int col)
	{
		super(par1, col);
		maxStackSize = 1;
		color = col;
	...
	{		
		SCPEntity217Testificate ent= new SCPEntity217Testificate(par0World);
