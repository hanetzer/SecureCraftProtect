...
public class SCPItem310 extends SCPItemDocument
{
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			par3World.setBlock(par4 + 3, par5 + 1, par6 + 3, mod_SCP.SCP310.blockID, 0, 2);
			par3World.setBlock(par4 + 3, par5, par6 + 3, Block.stone.blockID, 0, 2);	
			...
			par3World.setBlock(par4 + 2, par5 + 1, par6 - 3, mod_SCP.KeycardSlotLv2.blockID, 2, 2);
			par3World.setBlock(par4 + 3, par5 + 1, par6 - 1, mod_SCP.KeycardSlotLv2.blockID, 1, 2);

			int i = par3World.getBlockId(par4, par5, par6);
			--par1ItemStack.stackSize;
			par2EntityPlayer.addChatMessage("SCP-310 Spawned." + " | [Type: \u00a7eEuclid\u00a7f]");
