...
public class SCPItem280 extends SCPItemDocument
{
	...
	{
		list.add("\u00a74SCP-280");
		list.add("\u00a77The Eyes in the Dark");
	}
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			par2EntityPlayer.addChatMessage("SCP-280 Spawned." +    
	...
	{
		SCPEntity280 var8 = new SCPEntity280(par0World);
