...
public class SCPItem096 extends SCPItemDocument
{
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			par3World.setBlock(par4 + 1, par5 + 1, par6 + 7, 0, 0, 2);
			par3World.setBlock(par4 + 1, par5, par6 + 7, 0, 0, 2);
			...
			par2EntityPlayer.addChatMessage("SCP-096 Spawned." +    
