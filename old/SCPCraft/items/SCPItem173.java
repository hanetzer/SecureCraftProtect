...
public class SCPItem173 extends SCPItemDocument
{
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			par3World.setBlock(par4 + 2, par5 - 1, par6 + 7, mod_SCP.Locker.blockID, 0, 2);
			par3World.setBlock(par4 + 3, par5 - 1, par6 + 7, mod_SCP.Locker.blockID, 0, 2);
			par3World.setBlock(par4, par5 - 1, par6 + 1, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 1, par5 - 1, par6 + 1, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 2, par5 - 1, par6 + 1, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 1, par5 - 1, par6 + 1, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 2, par5 - 1, par6 + 1, Block.blockSteel.blockID, 0, 2);
			par3World.setBlock(par4, par5 - 1, par6 + 2, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 1, par5 - 1, par6 + 2, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 2, par5 - 1, par6 + 2, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 1, par5 - 1, par6 + 2, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 2, par5 - 1, par6 + 2, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4, par5 - 1, par6 + 3, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 1, par5 - 1, par6 + 3, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 2, par5 - 1, par6 + 3, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 1, par5 - 1, par6 + 3, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 2, par5 - 1, par6 + 3, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4, par5 - 1, par6 + 4, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 1, par5 - 1, par6 + 4, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 2, par5 - 1, par6 + 4, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 1, par5 - 1, par6 + 4, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 2, par5 - 1, par6 + 4, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4, par5 - 1, par6 + 5, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 1, par5 - 1, par6 + 5, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 2, par5 - 1, par6 + 5, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 1, par5 - 1, par6 + 5, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 2, par5 - 1, par6 + 5, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4, par5 - 1, par6 + 6, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 1, par5 - 1, par6 + 6, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 + 2, par5 - 1, par6 + 6, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 1, par5 - 1, par6 + 6, mod_SCP.BloodBlock.blockID, 0, 2);
			par3World.setBlock(par4 - 2, par5 - 1, par6 + 6, mod_SCP.BloodBlock.blockID, 0, 2);
			...
			par3World.setBlock(par4 - 3, par5 + 1, par6 - 1, mod_SCP.KeycardSlotLv2.blockID, 0, 2); //2
			par3World.setBlock(par4 - 1, par5 + 1, par6 + 1, mod_SCP.KeycardSlotLv2.blockID, 0, 2); //0
			
			ItemDoor.placeDoorBlock(par3World, par4 - 2, par5, par6, 1, Block.doorSteel);
	
			par2EntityPlayer.addChatMessage("SCP-173 Spawned." +    
	...
	{
		SCPEntity173 var8 = new SCPEntity173(par0World);
