...
public class SCPItem1440 extends SCPItemDocument
{
	...
	{
		list.add("\u00a74SCP-1440");
		list.add("\u00a77The Old Man from Nowhere");
	}
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			par2EntityPlayer.addChatMessage("SCP-1440 Spawned." +    
	...
	{
		SCPEntity1440 var8 = new SCPEntity1440(par0World);
