...
public class RenderTileSCP0015 implements ISimpleBlockRenderingHandler
{
									...
									Block block, int ID, RenderBlocks render)
	{
		if (block instanceof TileSCP0015)
		{
			...
			if (D)
			{
				render.setRenderBounds(0.33F, 0.0F, 0.33F, 0.66F, 0.33F,
						0.66F);
				render.renderStandardBlock(pipe, x, y, z);
			}
			if (U)
			...
			if (N)
			{
				render.setRenderBounds(0.33F, 0.33F, 0.0F, 0.66F, 0.66F,
						0.33F);
				render.renderStandardBlock(pipe, x, y, z);
			}
			if (S)
			...
			if (W)
			{
				render.setRenderBounds(0.0F, 0.33F, 0.33F, 0.33F, 0.66F,
						0.66F);
				render.renderStandardBlock(pipe, x, y, z);
			}
			if (E)
