...
public class RenderSCP0015 extends RenderLiving {
    ...
    private float scale;
    private static final ResourceLocation start = new ResourceLocation("scp:textures/entity/0015/start.png");
    private static final ResourceLocation half = new ResourceLocation("scp:textures/entity/0015/half.png");
    private static final ResourceLocation dead = new ResourceLocation("scp:textures/entity/0015/dead.png");
    ...
    public void renderBlaze(EntitySCP0015 entity, double par2, double par4, double par6, float par8, float par9) {
        entityPipe = entity;
    ...
    protected void renderDragonModel(EntitySCP0015 entity, float par2, float par3, float par4, float par5, float par6, float par7) {
    ...
    protected void renderModel(EntityLiving par1EntityLiving, float par2, float par3, float par4, float par5, float par6, float par7) {
        this.renderDragonModel((EntitySCP0015) par1EntityLiving, par2, par3, par4, par5, par6, par7);
    }

    public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
        this.renderBlaze((EntitySCP0015) par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    public void doRender(Entity entity, double par2, double par4, double par6, float par8, float par9) {
        this.renderBlaze((EntitySCP0015) entity, par2, par4, par6, par8, par9);
    }
