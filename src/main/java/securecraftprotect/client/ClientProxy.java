...
public class ClientProxy extends CommonProxy
{
	...
	private void render()
	{
		...
		RenderingRegistry.registerBlockHandler(RENDER_PIPE,
				new RenderTileSCP0015());
		RENDER_DESK = RenderingRegistry.getNextAvailableRenderId();
		RenderingRegistry.registerBlockHandler(RENDER_DESK,
				new RenderTileDesk());
		RENDER_CHAIR = RenderingRegistry.getNextAvailableRenderId();
		RenderingRegistry.registerBlockHandler(RENDER_CHAIR,
				new RenderTileChair());
	}
