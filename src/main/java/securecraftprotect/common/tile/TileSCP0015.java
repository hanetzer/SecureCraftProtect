...
public class TileSCP0015 extends BlockContainer
{
	...
	public boolean canPaneConnectTo(IBlockAccess w, int x, int y, int z,
									ForgeDirection dir)
	{
		return canPaneConnectToBlock(w.getBlock(x, y, z)) ||
				w.isSideSolid(x, y, z, dir.getOpposite(), false);
	}
									...
									float u, float v, float w)
	{
		int p[] = {
				...
				Potion.digSlowdown.id, Potion.moveSlowdown.id,
				Potion.weakness.id,
	...
	public AxisAlignedBB getSelectedBoundingBoxFromPool(World w, int x, int y, int z) {
		...
		if (D) setBlockBounds(0.33F, 0.0F, 0.33F, 0.66F, 0.66F, 0.66F);
		if (U) setBlockBounds(0.33F, 0.33F, 0.33F, 0.66F, 1F, 0.66F);
		if (N) setBlockBounds(0.33F, 0.33F, 0.0F, 0.66F, 0.66F, 0.66F);
		if (S) setBlockBounds(0.33F, 0.33F, 0.33F, 0.66F, 0.66F, 1F);
        if (W) setBlockBounds(0.0F, 0.33F, 0.33F, 0.66F, 0.66F, 0.66F);
        if (E) setBlockBounds(0.33F, 0.33F, 0.33F, 1F, 0.66F, 0.66F);
